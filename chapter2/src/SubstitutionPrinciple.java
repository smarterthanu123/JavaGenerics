 ...
 * type, and a method with a parameter of a given type may be invoked with an argument of any
...
public class SubstitutionPrinciple {
  ...
  public static void main(String[] args) {
    ...
    System.out.println(add(n,
        3.14)); // Assigning double (will be boxed to Double by compiler) to Number argument of
    // the method.
    ...
    // nums = ints; DOES NOT WORK! Why? because if this is allowed and then we do nums.add(3.14),
    // we would be adding double to List<Integer> and Double is not a subtype of Integer.
